...
export default function Card({ slug, name, description, image }: Mentor) {
  return (
    ...
    >
      <UICard className="flex flex-col items-center text-center bg-white rounded-2xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow w-full sm:aspect-[3/2] border-none">
        {/* Avatar */}
        <div className="mt-4">
