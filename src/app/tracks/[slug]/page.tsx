...
export default function TrackDetailPage({ params }: Params) {
  ...
  return (
    <article className="max-w-4xl mx-auto py-12 px-4">
      ...
      <nav aria-label="Breadcrumb" className="text-sm mb-6">
        ...
        <Link href="/track" className="text-gray-600 hover:text-gray-900">Track</Link>
        <span className="mx-2 text-gray-400">/</span>
      ...
      <section className="prose prose-lg mx-auto space-y-6">
        <p>
          In the <strong>{track.title}</strong> track, you will learn the essential skills and tools to get started hands‑on.
        </p>
        ...
        <h2>Prerequisites</h2>
        <p>
          You should have a solid foundation in programming (JavaScript/TypeScript) or relevant experience depending on the track.
        </p>
      </section>
    </article>
  );
