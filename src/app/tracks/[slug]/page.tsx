...
export default async function TrackDetailPage({
  ...
  return (
    <>
      ...
      <article className="flex-grow container mx-auto px-4 py-12">
        <div className="w-full mx-auto max-w-screen-sm md:max-w-2xl lg:max-w-3xl xl:max-w-[1100px]">
          ...
          <section className="max-w-none mx-auto mb-12 px-4">
          ...
          {/* Details */}
          <section className="prose prose-lg mx-auto space-y-6 mb-12 px-4 max-w-none">
