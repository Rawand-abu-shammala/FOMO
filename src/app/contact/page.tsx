...
//           rows={8}
//           className="bg-gray-100 border-none focus:ring-0 p-3 w-full h-48"
//         />
//       </div>
...
//   return (
//     <div className="p-4 sm:p-6 flex flex-col md:flex-row items-start gap-8">
//       {/* Form Section */}
//       <div className="flex-1 w-full max-w-lg">
...
//           <Button
//             type="submit"
//             className="w-full md:w-auto bg-blue-600 text-white text-center px-6 py-3"
//           >
//             Send
//           </Button>
//         </form>
