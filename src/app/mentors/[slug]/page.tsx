...
//   const mentor = mentorsData.find((m) => m.slug === params.slug)
//   return { title: mentor?.name ?? 'Mentor Profile' }
// }

// export default function MentorProfile({ params }: Params) {
//   const mentor = mentorsData.find((m) => m.slug === params.slug)
//   if (!mentor) notFound()
...
//      {/* Action Buttons using chadcn UI */}
//           <div className="flex flex-wrap gap-4 pt-4">
//             <Button className="w-48 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Book session</Button>
//             <Button variant="outline" className="w-48 px-6 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition" asChild>
//               <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer">
//                 LinkedIn
//               </a>
//             </Button>
